...
schema_json = """{
  ...
  "properties": {
    "page_number": {
      "type": "string",
      "description": "number of page, top right corner"
    },
    "year": {
      "type": "string",
      "description": "year, middle top"
    },
    "blocks": {
      "type": "array",
      ...
      "items": {
        ...
        "properties": {
          "type": {
            "type": "string",
            "description": "Type de bloc : heading, paragraph, table, list "
          },
          "text": {
            "type": "string",
            "description": "Texte exact du bloc"
          }
        },
        "required": [
          "type",
